...
import {
  FiPhone, FiMail, FiInstagram, FiLinkedin, FiYoutube, FiGithub, FiCheck, FiMapPin,
} from 'react-icons/fi'
    ...
    <section id="contact" className="relative section-pad">
      <Reveal className="max-w-2xl mb-16">
        ...
        <p className="text-mist-500 mt-4">
          Have a project in mind? Fill out the form or reach out directly — I usually reply within a few hours.
        </p>
      </Reveal>
          ...
          <form onSubmit={submit} className="card p-6 sm:p-8 space-y-5">
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm focus:border-violet-400 outline-none"
                />
              </div>
              <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm focus:border-violet-400 outline-none text-mist-200"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm focus:border-violet-400 outline-none resize-none"
              />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  data-cursor-hover
                  aria-label={s.label}
                  className="aspect-square rounded-xl bg-white/5 flex items-center justify-center hover:bg-grad-violet-cyan hover:text-ink-950 text-mist-300 transition-all duration-300"
                >
                  <s.icon size={18} />
                </a>
              ))}
